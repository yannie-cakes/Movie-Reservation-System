...
CREATE TABLE CINEMA(
CIN_ID INT NOT NULL PRIMARY KEY,
...
CUS_NUMBER INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
...
INSERT INTO EMPLOYEE(EMP_FNAME, EMP_MNAME, EMP_LNAME, EMP_ROLE)
	VALUE('Jane Albert', 'Dela Torre', 'Balagtas', 'Admin');
    
alter table MOVIE drop column MOV_SHOWING;

alter table MOVIE ADD column MOV_PRICE INT NOT NULL DEFAULT 400;

SELECT * FROM MOVIE;

ALTER TABLE MOVIE ADD MOV_DATE DATE;

alter table TRANSACTIONS ADD column CUS_ID INT NOT NULL;
ALTER TABLE TRANSACTIONS ADD FOREIGN KEY (CUS_ID) REFERENCES
CUSTOMER(CUS_ID)
